"""
Um passeio aleatório é um caminho que não tem direção clara, determinado
por uma série de decisões aleatórias, em que cada uma é deixada totalmente
ao acaso. Passeios aleatórios tem aplicações práticas na natureza, em 
física, biologia, química e economia. 
Criaremos a classe RandomWalk, que tomará decisões aleatórias sobre o 
caminho do passeio. 
"""
